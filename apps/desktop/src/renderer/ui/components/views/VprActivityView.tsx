...
export function VprActivityView({ onSelectView }: Props) {
  ...
  // Router savings is a separate figure scoped to Auto-routed requests
  // specifically, shown alongside "Saved" rather than folded into it.
  // Absent entirely for a buyer who never used Auto, same reasoning as
  // VprHomeView's tile.
