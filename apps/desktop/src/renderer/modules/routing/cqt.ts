/**
 * CQT (cost/quality tradeoff) dial. Five discrete UI positions map onto
 ...
 * deliberately avoid "save X%" language.
 *
 * Position labels beyond the middle one ("Balanced") are a UI copy choice,
 * not tied to any specific underlying value.
 */
