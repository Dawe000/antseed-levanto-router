 ...
 * a real day-pass-flow bug spanning the buyer and seller as two separate
 * processes: getting any correlated evidence meant re-running throwaway
 * scripts with stdout manually redirected each time. Set
 * `ANTSEED_DEBUG_LOG_FILE=<path>`
