...
describe('EIP-712 golden vectors', () => {
  ...
  it('defaults chargeType to metered, and a day-pass-on-demand charge hashes differently', () => {
    ...
    expect(computeMetadataHash({ ...base, chargeType: CHARGE_TYPE_DAY_PASS_ON_DEMAND })).not.toBe(
